...
<style>
.wa-card    { background: #1a1a2e; border: 1px solid #2d2d42; border-radius: 12px; padding: 28px; width: 100%; }
...
.wa-two-col { display: grid; grid-template-columns: 1fr 1fr; gap: 16px; }
@media(max-width: 700px) { .wa-two-col { grid-template-columns: 1fr; } }
</style>
...
<div class="wa-card">
    ...
    <div class="wa-two-col">
        <div class="wa-field">
            ...
            <p class="wa-hint">Meta Business Manager → Configuración → WhatsApp Business.</p>
        </div>
        <div class="wa-field">
            ...
            <p class="wa-hint">Meta for Developers → Tu App → WhatsApp → Configuración de la API.</p>
        </div>
    </div>
    ...
    {{-- Acciones --}}
    <div style="margin-top: 28px; display: flex; align-items: center; flex-wrap: wrap; gap: 10px;">
        ...
        <span style="font-size: 13px; color: #4ade80; font-weight: 600;">🟢 Conectado</span>
        @elseif($connectionStatus !== '')
        <span style="font-size: 13px; color: #f87171; font-weight: 600;">🔴 {{ \Illuminate\Support\Str::after($connectionStatus, 'error:') }}</span>
        @endif
    </div>
