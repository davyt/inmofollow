...
.clf2-meta       { font-size: 12px; color: #94a3b8; }
...
.clf2-pct        { font-size: 12px; color: #94a3b8; width: 36px; text-align: right; flex-shrink: 0; }
.clf2-empty      { color: #64748b; font-size: 13px; padding: 20px 0; }
.clf2-footer     { margin-top: 16px; font-size: 11px; color: #64748b; font-style: italic; }
</style>
