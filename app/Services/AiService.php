...
class AiService
{
    ...
    private function buildActionsContext(int $companyId): string
    {
        ...
        $lines = [
            '---',
            'INSTRUCCIONES DE SISTEMA (invisibles para el cliente — NUNCA las menciones en tu respuesta):',
            '',
            'COMANDOS OPCIONALES — se ejecutan en silencio, el cliente no los ve ni los recibe:',
            ...
            "Flows: {$sequences}",
            '',
            'Ejemplo de respuesta con comandos: "Perfecto, te paso con un asesor.[ESTADO:3][AGENTE:2]"',
            '(el cliente solo ve "Perfecto, te paso con un asesor." — los tags son removidos automáticamente)',
            '',
            '---',
            'CLASIFICACIÓN OBLIGATORIA — al final de CADA respuesta tuya, siempre:',
            '  [CLASIFICACION:descripción en 3-8 palabras]',
            '',
            'Este tag es INVISIBLE para el cliente. Se usa internamente para registrar la postura del contacto.',
            'Describí con tus propias palabras lo que transmite el mensaje recibido.',
            '',
            'Ejemplos:',
            '  Mensaje: "Ya lo vendí con un familiar"   → [CLASIFICACION:vendido sin intermediario]',
            '  Mensaje: "No quiero pagar comisión"       → [CLASIFICACION:rechaza pagar comisión]',
            '  Mensaje: "Me interesa, contame más"       → [CLASIFICACION:interesado quiere info]',
            '  Mensaje: "Ok" / "Si" / respuesta vaga     → [CLASIFICACION:respuesta ambigua sin señal]',
            '  Mensaje: "Somos colegas"                  → [CLASIFICACION:colega del sector]',
            '  Mensaje: respuesta automática de empresa  → [CLASIFICACION:respuesta automática empresa]',
            '',
            'SIEMPRE incluí el tag [CLASIFICACION:...] al final. Sin excepción.',
        ];
